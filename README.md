...
*	Allows the app to list groups, read basic properties, read and update the membership of your groups by using <b><i>GroupMember.ReadWrite.All</i></b>
...
### Powershell data source '[powershell-datasource]_Teams-get-azure-users'

### Powershell data source '[powershell-datasource]_Teams-get-team-users'

### Delegated form task '[task]_Teams - Assign Team Members'
